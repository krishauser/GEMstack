...
def generate_messages_notoken(data_sample, use_peception=True, use_short_experience=True, verbose=True, use_gt_cot=False):
    ego = data_sample["ego"]
    perception = data_sample["perception"]
    commonsense = data_sample["commonsense"]
    experiences =  data_sample["experiences"]
...
def planning_single_inference_notoken(
        planner_model_id, 
        data_sample, 
        data_dict=None, 
        self_reflection=True,
    ...
    user_message, assitant_message = generate_messages_notoken(data_sample, verbose=False)
