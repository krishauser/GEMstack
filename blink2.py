...
class BlinkDistress:
    ...
    """
    def msg_callback(self, msg:SystemRptFloat):
        rospy.loginfo("Manual input: " + msg.manual_input + ",   Command: "+msg.command)
        
    def __init__(self):
        # TODO: Initialize your publishers and subscribers here
        rospy.init_node("Blinker")
        sub1 = rospy.Subscriber("/pacmod/parsed_tx/accel_rpt", SystemRptFloat, callback= self.msg_callback)
        sub2 = rospy.Subscriber("/pacmod/parsed_tx/brake_rpt", SystemRptFloat, callback= self.msg_callback)
