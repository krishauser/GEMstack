...
# https://publish.illinois.edu/robotics-autonomy-resources/gem-e4/hardware/
# red x, green y, blue z

T_livox2baselink = np.array([
    [ np.cos(0.314) , 0             , np.sin(0.314) , 1.46 - 0.90 ],
    [0              , 1             , 0             , 0     ],
    [-np.sin(0.314) , 0             , np.cos(0.314) , 1.64 + 0.20  ],
    [0              , 0             , 0             , 1     ]
])  # front lidar
