...
python3 segment-anything/scripts/amg.py --checkpoint sam_vit_b.pth --model-type vit_b --input $data/images --output $data/masks/ --stability-score-thresh 0.9 --box-nms-thresh 0.5 --stability-score-offset 0.9
