...
export function VehicleInfoPanel({ time }: { time: number }) {
  ...
  return (
    <>
      <div
        className={`fixed top-0 right-0 w-72 h-full bg-black/80 text-white shadow-lg transform transition-transform duration-300 ease-in-out z-40 p-4 overflow-y-auto text-sm ${
