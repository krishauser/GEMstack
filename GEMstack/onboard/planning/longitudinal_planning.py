...
class YieldTrajectoryPlanner(Component):
    ...
    def update(self, state : AllState):
        ...
        for r in state.relations:
            if r.type == EntityRelationEnum.YIELDING and r.obj1 == '':
                ...
                if isinstance(deceleration, list):
                    ...
                    traj = longitudinal_plan(route_to_end, self.acceleration, deceleration, desired_speed, curr_v, "dt")
                    return traj
                else:
        ...
        if should_accelerate:
            ...
            traj = longitudinal_plan(route_to_end, 0.0, self.deceleration, self.desired_speed, curr_v, "dt")
        return traj 
