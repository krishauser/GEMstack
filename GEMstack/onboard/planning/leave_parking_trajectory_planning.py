...
class LeaveParkingTrajectoryPlanner(Component):
    ...
    def update(self, state: AllState):
        ...
        traj = None
        # TODO: implement leave parking trajectory planning
        ...
        # TODO: Modify to leave from stop aside the target location
            ...
            traj = generate_turn_trajectory(vehicle, turn_angle=15, turn_radius=3.0, turn_direction="left", num_points=10)
