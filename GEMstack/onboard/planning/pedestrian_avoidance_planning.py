...
class PedestrianAvoidanceMotionPlanner(Component):
    ...
    def update(self, state : AllState):
        ...
        while progress < progress_end:
            ...
            gem_dim = vehicle.to_object()
            l,w,h = gem_dim.dimensions
            new_l, new_w = l + safe_long, w + safe_lat
            gem_dim.dimensions = (new_l, new_w, h)
            vehicle_poly_world = gem_dim.polygon_parent()
