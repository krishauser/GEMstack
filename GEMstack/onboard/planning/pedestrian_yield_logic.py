...
if GEM_MODEL == 'e2':
    size_x, size_y = 2.53, 1.35
    lx_f2r = 0.88 + 0.87
    ly_axle = 0.6 * 2
    l_rear_axle_to_front = 1.28 + 0.87
    l_rear_axle_to_rear = size_x - l_rear_axle_to_front
elif GEM_MODEL == 'e4':
    size_x, size_y = 3.35, 1.35
    lx_f2r = 1.2746 + 1.2904
    ly_axle = 0.6545 * 2
    l_rear_axle_to_front = 1.68 + 1.29
    l_rear_axle_to_rear = size_x - l_rear_axle_to_front
...
def check_collision_in_vehicle_frame(agent: AgentState, vehicle: VehicleState):
    ...
    # Collision logic based on distance and time thresholds
