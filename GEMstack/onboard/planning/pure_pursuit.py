...
#             if len(self.trajectory.points) < 2 or self.current_path_parameter >= self.path.domain()[1]:
#                 print("Trajectory is over. Time to stop")
#                 self.reached = True
#                 if component is not None:
#                     component.debug_event('Past the end of trajectory')
#                 #past the end, just stop
...
#                 feedforward_accel = -2.0
#                 f_delta = 0
#                 print("Desired speed",desired_speed,"m/s",self.speed_limit)
...
#         self.t_last = t
#         print("Output acceleration: " + str(output_accel) + " m/s^2")
