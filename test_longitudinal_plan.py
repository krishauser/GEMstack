...
import GEMstack.onboard.planning.longitudinal_planning as GM
...
def test_longitudinal_planning():
    ...
    test_traj = GM.longitudinal_brake(test_path, 2.0, 0.0)
    ...
    test_traj = GM.longitudinal_brake(test_path, 2.0, 2.0)
    assert (t1 < t2 for (t1,t2) in zip(test_traj.times[:-1],test_traj.times[1:]) )
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_plan(test_path, 1.0, 2.0, 3.0, 0.0)
    assert (t1 < t2 for (t1,t2) in zip(test_traj.times[:-1],test_traj.times[1:]) )
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_plan(test_path, 1.0, 2.0, 3.0, 2.0)
    assert (t1 < t2 for (t1,t2) in zip(test_traj.times[:-1],test_traj.times[1:]) )
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_plan(test_path, 0.0, 2.0, 3.0, 3.1)
    assert (t1 < t2 for (t1,t2) in zip(test_traj.times[:-1],test_traj.times[1:]) )
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_plan(test_path, 2.0, 2.0, 20.0, 10.0)
    assert (t1 < t2 for (t1,t2) in zip(test_traj.times[:-1],test_traj.times[1:]) )
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_brake(test_path, 2.0, 10.0)
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
    ...
    test_traj = GM.longitudinal_plan(test_path2, 1.0, 2.0, 3.0, 0.0)
    plt.plot(test_traj.times,[p[0] for p in test_traj.points])
