...
;//! \htmlinclude NovatelHeading2.msg.html

(cl:defclass <NovatelHeading2> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
   ...
   (pitch_sigma
    ...
    :initform 0.0)
   (rover_station_id
    :reader rover_station_id
    :initarg :rover_station_id
    :type cl:string
    :initform "")
   (master_station_id
    :reader master_station_id
    :initarg :master_station_id
    :type cl:string
    :initform "")
...
(cl:defclass NovatelHeading2 (<NovatelHeading2>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <NovatelHeading2>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'NovatelHeading2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name novatel_gps_msgs-msg:<NovatelHeading2> is deprecated: use novatel_gps_msgs-msg:NovatelHeading2 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <NovatelHeading2>))
...
(cl:defmethod novatel_msg_header-val ((m <NovatelHeading2>))
...
(cl:defmethod solution_status-val ((m <NovatelHeading2>))
...
(cl:defmethod position_type-val ((m <NovatelHeading2>))
...
(cl:defmethod baseline_length-val ((m <NovatelHeading2>))
...
(cl:defmethod heading-val ((m <NovatelHeading2>))
...
(cl:defmethod pitch-val ((m <NovatelHeading2>))
...
(cl:defmethod heading_sigma-val ((m <NovatelHeading2>))
...
(cl:defmethod pitch_sigma-val ((m <NovatelHeading2>))
...
(cl:ensure-generic-function 'rover_station_id-val :lambda-list '(m))
(cl:defmethod rover_station_id-val ((m <NovatelHeading2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader novatel_gps_msgs-msg:rover_station_id-val is deprecated.  Use novatel_gps_msgs-msg:rover_station_id instead.")
  (rover_station_id m))

(cl:ensure-generic-function 'master_station_id-val :lambda-list '(m))
(cl:defmethod master_station_id-val ((m <NovatelHeading2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader novatel_gps_msgs-msg:master_station_id-val is deprecated.  Use novatel_gps_msgs-msg:master_station_id instead.")
  (master_station_id m))

(cl:ensure-generic-function 'num_satellites_tracked-val :lambda-list '(m))
(cl:defmethod num_satellites_tracked-val ((m <NovatelHeading2>))
...
(cl:defmethod num_satellites_used_in_solution-val ((m <NovatelHeading2>))
...
(cl:defmethod num_satellites_above_elevation_mask_angle-val ((m <NovatelHeading2>))
...
(cl:defmethod num_satellites_above_elevation_mask_angle_l2-val ((m <NovatelHeading2>))
...
(cl:defmethod solution_source-val ((m <NovatelHeading2>))
...
(cl:defmethod extended_solution_status-val ((m <NovatelHeading2>))
...
(cl:defmethod signal_mask-val ((m <NovatelHeading2>))
  ...
  (signal_mask m))
(cl:defmethod roslisp-msg-protocol:symbol-codes ((msg-type (cl:eql '<NovatelHeading2>)))
    "Constants for message type '<NovatelHeading2>"
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <NovatelHeading2>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'pitch_sigma))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'rover_station_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'rover_station_id))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'master_station_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'master_station_id))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <NovatelHeading2>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'novatel_msg_header) istream)
    ...
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'rover_station_id) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'rover_station_id) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'master_station_id) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'master_station_id) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <NovatelHeading2>))
  (cl:+ 0
     ...
     4
     4
     4 (cl:length (cl:slot-value msg 'rover_station_id))
     4 (cl:length (cl:slot-value msg 'master_station_id))
     1
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <NovatelHeading2>))
  "Converts a ROS message object to a list"
  (cl:list 'NovatelHeading2
    ...
    (cl:cons ':rover_station_id (rover_station_id msg))
    (cl:cons ':master_station_id (master_station_id msg))
