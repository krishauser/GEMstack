...
(cl:defclass <EsrVehicle2> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (vehicle_speed_validity
    :reader vehicle_speed_validity
    :initarg :vehicle_speed_validity
    :type cl:boolean
    :initform cl:nil)
   (mmr_upside_down
   ...
   (wiper_status
    ...
    :initform cl:nil)
   (raw_data_enable
    :reader raw_data_enable
    :initarg :raw_data_enable
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:ensure-generic-function 'vehicle_speed_validity-val :lambda-list '(m))
(cl:defmethod vehicle_speed_validity-val ((m <EsrVehicle2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:vehicle_speed_validity-val is deprecated.  Use delphi_esr_msgs-msg:vehicle_speed_validity instead.")
  (vehicle_speed_validity m))
...
(cl:ensure-generic-function 'raw_data_enable-val :lambda-list '(m))
(cl:defmethod raw_data_enable-val ((m <EsrVehicle2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:raw_data_enable-val is deprecated.  Use delphi_esr_msgs-msg:raw_data_enable instead.")
  (raw_data_enable m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrVehicle2>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'vehicle_speed_validity) 1 0)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'raw_data_enable) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrVehicle2>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:slot-value msg 'vehicle_speed_validity) (cl:not (cl:zerop (cl:read-byte istream))))
    ...
    (cl:setf (cl:slot-value msg 'raw_data_enable) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrVehicle2>)))
  ...
  "61e3faf0995a56e00626a0aff07d2736")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrVehicle2)))
  "Returns md5sum for a message object of type 'EsrVehicle2"
  "61e3faf0995a56e00626a0aff07d2736")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle2>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle2~%uint16      scan_index_ack~%bool        use_angle_misalignment~%bool        clear_faults~%int8        high_yaw_angle~%bool        mr_only_transmit~%bool        lr_only_transmit~%float32     angle_misalignment~%float32     lateral_mounting_offset~%bool        radar_cmd_radiate~%bool        blockage_disable~%uint8       maximum_tracks~%uint8       turn_signal_status~%bool        vehicle_speed_validity~%bool        mmr_upside_down~%uint8       grouping_mode~%bool        wiper_status~%bool        raw_data_enable~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle2)))
  "Returns full string definition for message of type 'EsrVehicle2"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle2~%uint16      scan_index_ack~%bool        use_angle_misalignment~%bool        clear_faults~%int8        high_yaw_angle~%bool        mr_only_transmit~%bool        lr_only_transmit~%float32     angle_misalignment~%float32     lateral_mounting_offset~%bool        radar_cmd_radiate~%bool        blockage_disable~%uint8       maximum_tracks~%uint8       turn_signal_status~%bool        vehicle_speed_validity~%bool        mmr_upside_down~%uint8       grouping_mode~%bool        wiper_status~%bool        raw_data_enable~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
