...
(cl:defclass <EsrVehicle1> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (vehicle_speed_direction
    :reader vehicle_speed_direction
    :initarg :vehicle_speed_direction
    :type cl:boolean
    :initform cl:nil)
   (yaw_rate
    :reader yaw_rate
    ...
    :initform 0.0)
   (yaw_rate_validity
    :reader yaw_rate_validity
    :initarg :yaw_rate_validity
    :type cl:boolean
    :initform cl:nil)
   ...
   (steering_angle_validity
    :reader steering_angle_validity
    :initarg :steering_angle_validity
    :type cl:boolean
    :initform cl:nil)
   (steering_angle_sign
...
(cl:ensure-generic-function 'vehicle_speed_direction-val :lambda-list '(m))
(cl:defmethod vehicle_speed_direction-val ((m <EsrVehicle1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:vehicle_speed_direction-val is deprecated.  Use delphi_esr_msgs-msg:vehicle_speed_direction instead.")
  (vehicle_speed_direction m))
...
(cl:ensure-generic-function 'yaw_rate_validity-val :lambda-list '(m))
(cl:defmethod yaw_rate_validity-val ((m <EsrVehicle1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:yaw_rate_validity-val is deprecated.  Use delphi_esr_msgs-msg:yaw_rate_validity instead.")
  (yaw_rate_validity m))
...
(cl:ensure-generic-function 'steering_angle_validity-val :lambda-list '(m))
(cl:defmethod steering_angle_validity-val ((m <EsrVehicle1>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:steering_angle_validity-val is deprecated.  Use delphi_esr_msgs-msg:steering_angle_validity instead.")
  (steering_angle_validity m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrVehicle1>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'vehicle_speed_direction) 1 0)) ostream)
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'yaw_rate))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'yaw_rate_validity) 1 0)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'steering_angle_validity) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrVehicle1>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:slot-value msg 'vehicle_speed_direction) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
    ...
    (cl:setf (cl:slot-value msg 'yaw_rate_validity) (cl:not (cl:zerop (cl:read-byte istream))))
    ...
    (cl:setf (cl:slot-value msg 'steering_angle_validity) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrVehicle1>)))
  ...
  "72f3525a55255ecd3a2ea2c75fb27820")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrVehicle1)))
  "Returns md5sum for a message object of type 'EsrVehicle1"
  "72f3525a55255ecd3a2ea2c75fb27820")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle1>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle1~%float32     vehicle_speed~%bool        vehicle_speed_direction~%float32     yaw_rate~%bool        yaw_rate_validity~%bool        steering_angle_rate_sign~%int16       radius_curvature~%bool        steering_angle_validity~%bool        steering_angle_sign~%uint16      steering_angle~%uint16      steering_angle_rate~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle1)))
  "Returns full string definition for message of type 'EsrVehicle1"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle1~%float32     vehicle_speed~%bool        vehicle_speed_direction~%float32     yaw_rate~%bool        yaw_rate_validity~%bool        steering_angle_rate_sign~%int16       radius_curvature~%bool        steering_angle_validity~%bool        steering_angle_sign~%uint16      steering_angle~%uint16      steering_angle_rate~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsrVehicle1>))
  ...
  (cl:list 'EsrVehicle1
    ...
    (cl:cons ':vehicle_speed_direction (vehicle_speed_direction msg))
    (cl:cons ':yaw_rate (yaw_rate msg))
    (cl:cons ':yaw_rate_validity (yaw_rate_validity msg))
    (cl:cons ':steering_angle_rate_sign (steering_angle_rate_sign msg))
    (cl:cons ':radius_curvature (radius_curvature msg))
    (cl:cons ':steering_angle_validity (steering_angle_validity msg))
