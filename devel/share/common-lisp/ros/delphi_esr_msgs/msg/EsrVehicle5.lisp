...
(cl:defmethod wheelbase-val ((m <EsrVehicle5>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:wheelbase-val is deprecated.  Use delphi_esr_msgs-msg:wheelbase instead.")
  (wheelbase m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrVehicle5>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'wheelbase)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'wheelbase)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrVehicle5>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'wheelbase)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'wheelbase)) (cl:read-byte istream))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrVehicle5>)))
  ...
  "d50929309b9b0140d6d7a33bcaf123cc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrVehicle5)))
  "Returns md5sum for a message object of type 'EsrVehicle5"
  "d50929309b9b0140d6d7a33bcaf123cc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle5>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle5~%int8        oversteer_understeer~%bool        yaw_rate_bias_shift~%float32     beamwidth_vert~%float32     funnel_offset_left~%float32     funnel_offset_right~%float32     cw_blockage_threshold~%uint16      distance_rear_axle~%uint16      wheelbase~%float32     steering_gear_ratio~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle5)))
  "Returns full string definition for message of type 'EsrVehicle5"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle5~%int8        oversteer_understeer~%bool        yaw_rate_bias_shift~%float32     beamwidth_vert~%float32     funnel_offset_left~%float32     funnel_offset_right~%float32     cw_blockage_threshold~%uint16      distance_rear_axle~%uint16      wheelbase~%float32     steering_gear_ratio~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
