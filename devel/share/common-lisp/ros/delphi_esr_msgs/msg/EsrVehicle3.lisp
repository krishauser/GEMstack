...
(cl:defclass <EsrVehicle3> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (long_accel_validity
    :reader long_accel_validity
    :initarg :long_accel_validity
    :type cl:boolean
    :initform cl:nil)
   (lat_accel_validity
    :reader lat_accel_validity
    :initarg :lat_accel_validity
    :type cl:boolean
    :initform cl:nil)
   (lat_accel
    :reader lat_accel
   ...
   (aalign_avg_ctr_total
    :reader aalign_avg_ctr_total
    :initarg :aalign_avg_ctr_total
    :type cl:fixnum
    :initform 0)
...
(cl:ensure-generic-function 'long_accel_validity-val :lambda-list '(m))
(cl:defmethod long_accel_validity-val ((m <EsrVehicle3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:long_accel_validity-val is deprecated.  Use delphi_esr_msgs-msg:long_accel_validity instead.")
  (long_accel_validity m))

(cl:ensure-generic-function 'lat_accel_validity-val :lambda-list '(m))
(cl:defmethod lat_accel_validity-val ((m <EsrVehicle3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:lat_accel_validity-val is deprecated.  Use delphi_esr_msgs-msg:lat_accel_validity instead.")
  (lat_accel_validity m))
...
(cl:ensure-generic-function 'aalign_avg_ctr_total-val :lambda-list '(m))
(cl:defmethod aalign_avg_ctr_total-val ((m <EsrVehicle3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader delphi_esr_msgs-msg:aalign_avg_ctr_total-val is deprecated.  Use delphi_esr_msgs-msg:aalign_avg_ctr_total instead.")
  (aalign_avg_ctr_total m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EsrVehicle3>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'long_accel_validity) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'lat_accel_validity) 1 0)) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'aalign_avg_ctr_total)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'aalign_avg_ctr_total)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EsrVehicle3>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    (cl:setf (cl:slot-value msg 'long_accel_validity) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'lat_accel_validity) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((bits 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'aalign_avg_ctr_total)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'aalign_avg_ctr_total)) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EsrVehicle3>)))
  ...
  "584771b70916ae655b7479bcb4bbfe22")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EsrVehicle3)))
  "Returns md5sum for a message object of type 'EsrVehicle3"
  "584771b70916ae655b7479bcb4bbfe22")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle3>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle3~%bool        long_accel_validity~%bool        lat_accel_validity~%float32     lat_accel~%float32     long_accel~%uint8       radar_fov_lr~%uint8       radar_fov_mr~%bool        auto_align_disable~%uint8       radar_height~%bool        serv_align_type~%bool        serv_align_enable~%uint16      aalign_avg_ctr_total~%bool        auto_align_converged~%uint8       wheel_slip~%uint8       serv_align_updates_need~%int8        angle_mounting_offset~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle3)))
  "Returns full string definition for message of type 'EsrVehicle3"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle3~%bool        long_accel_validity~%bool        lat_accel_validity~%float32     lat_accel~%float32     long_accel~%uint8       radar_fov_lr~%uint8       radar_fov_mr~%bool        auto_align_disable~%uint8       radar_height~%bool        serv_align_type~%bool        serv_align_enable~%uint16      aalign_avg_ctr_total~%bool        auto_align_converged~%uint8       wheel_slip~%uint8       serv_align_updates_need~%int8        angle_mounting_offset~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EsrVehicle3>))
  ...
  (cl:list 'EsrVehicle3
    ...
    (cl:cons ':long_accel_validity (long_accel_validity msg))
    (cl:cons ':lat_accel_validity (lat_accel_validity msg))
    ...
    (cl:cons ':aalign_avg_ctr_total (aalign_avg_ctr_total msg))
