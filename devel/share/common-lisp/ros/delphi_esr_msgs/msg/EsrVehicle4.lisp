...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrVehicle4>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle4~%bool        fac_align_cmd_1~%bool        fac_align_cmd_2~%uint8       fac_align_max_nt~%uint8       fac_align_samp_req~%int8        fac_tgt_mtg_offset~%int8        fac_tgt_mtg_space_hor~%int8        fac_tgt_mtg_space_ver~%float32     fac_tgt_range_1~%float32     fac_tgt_range_r2m~%float32     fac_tgt_range_m2t~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrVehicle4)))
  "Returns full string definition for message of type 'EsrVehicle4"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Vehicle4~%bool        fac_align_cmd_1~%bool        fac_align_cmd_2~%uint8       fac_align_max_nt~%uint8       fac_align_samp_req~%int8        fac_tgt_mtg_offset~%int8        fac_tgt_mtg_space_hor~%int8        fac_tgt_mtg_space_ver~%float32     fac_tgt_range_1~%float32     fac_tgt_range_r2m~%float32     fac_tgt_range_m2t~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
