...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EsrEthTx>)))
  ...
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Track Msg~%uint16            xcp_format_version~%uint16            scan_index~%uint16            tcp_size~%uint8             xcp_scan_type~%uint16            look_index~%uint16            mmr_scan_index~%float32           target_report_host_speed~%float32           target_report_host_yaw_rate~%uint32            xcp_timestamp~%uint8             release_revision~%uint8             promote_revision~%uint8             field_revision~%uint8             target_report_count~%float32[64]       target_report_range~%float32[64]       target_report_range_rate~%float32[64]       target_report_theta~%float32[64]       target_report_amplitude~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EsrEthTx)))
  "Returns full string definition for message of type 'EsrEthTx"
  (cl:format cl:nil "std_msgs/Header header~%~%# ESR Track Msg~%uint16            xcp_format_version~%uint16            scan_index~%uint16            tcp_size~%uint8             xcp_scan_type~%uint16            look_index~%uint16            mmr_scan_index~%float32           target_report_host_speed~%float32           target_report_host_yaw_rate~%uint32            xcp_timestamp~%uint8             release_revision~%uint8             promote_revision~%uint8             field_revision~%uint8             target_report_count~%float32[64]       target_report_range~%float32[64]       target_report_range_rate~%float32[64]       target_report_theta~%float32[64]       target_report_amplitude~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
