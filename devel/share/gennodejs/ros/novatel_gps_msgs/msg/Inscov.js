...
class Inscov {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('attitude_covariance')) {
        this.attitude_covariance = initObj.attitude_covariance
      }
      else {
        this.attitude_covariance = new Array(9).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [attitude_covariance] has the right length
    if (obj.attitude_covariance.length !== 9) {
      throw new Error('Unable to serialize array field attitude_covariance - length must be 9')
    }
    // Serialize message field [attitude_covariance]
    bufferOffset = _arraySerializer.float64(obj.attitude_covariance, buffer, bufferOffset, 9);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [attitude_covariance]
    data.attitude_covariance = _arrayDeserializer.float64(buffer, bufferOffset, 9)
  ...
  static Resolve(msg) {
    ...
    if (msg.attitude_covariance !== undefined) {
      resolved.attitude_covariance = msg.attitude_covariance;
    }
    else {
      resolved.attitude_covariance = new Array(9).fill(0)
    }
