...
class NovatelDualAntennaHeading {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NovatelDualAntennaHeading(null);
  ...
  static datatype() {
    ...
    return 'novatel_gps_msgs/NovatelDualAntennaHeading';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '9e80eaa83bf25f057aea59ce70d859e5';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new NovatelDualAntennaHeading(null);
...
NovatelDualAntennaHeading.Constants = {
  SOURCE_PRIMARY_ANTENNA: 0,
  SOURCE_SECONDARY_ANTENNA: 1,
}

module.exports = NovatelDualAntennaHeading;
