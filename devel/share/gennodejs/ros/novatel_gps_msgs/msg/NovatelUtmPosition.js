...
class NovatelUtmPosition {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.datum_id = null;
      this.northing_sigma = null;
      this.easting_sigma = null;
      ...
      if (initObj.hasOwnProperty('northing_sigma')) {
        this.northing_sigma = initObj.northing_sigma
      }
      else {
        this.northing_sigma = 0.0;
      }
      if (initObj.hasOwnProperty('easting_sigma')) {
        this.easting_sigma = initObj.easting_sigma
      }
      else {
        this.easting_sigma = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.string(obj.lat_zone_letter, buffer, bufferOffset);
    ...
    // Serialize message field [northing_sigma]
    bufferOffset = _serializer.float32(obj.northing_sigma, buffer, bufferOffset);
    // Serialize message field [easting_sigma]
    bufferOffset = _serializer.float32(obj.easting_sigma, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NovatelUtmPosition(null);
    ...
    data.lat_zone_letter = _deserializer.string(buffer, bufferOffset);
    ...
    // Deserialize message field [northing_sigma]
    data.northing_sigma = _deserializer.float32(buffer, bufferOffset);
    // Deserialize message field [easting_sigma]
    data.easting_sigma = _deserializer.float32(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.lat_zone_letter);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NovatelUtmPosition(null);
    ...
    if (msg.northing_sigma !== undefined) {
      resolved.northing_sigma = msg.northing_sigma;
    }
    else {
      resolved.northing_sigma = 0.0
    }

    if (msg.easting_sigma !== undefined) {
      resolved.easting_sigma = msg.easting_sigma;
    }
    else {
      resolved.easting_sigma = 0.0
    }
...
module.exports = NovatelUtmPosition;
