...
class EsrVehicle2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('vehicle_speed_validity')) {
        this.vehicle_speed_validity = initObj.vehicle_speed_validity
      }
      else {
      ...
      if (initObj.hasOwnProperty('raw_data_enable')) {
        this.raw_data_enable = initObj.raw_data_enable
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [vehicle_speed_validity]
    bufferOffset = _serializer.bool(obj.vehicle_speed_validity, buffer, bufferOffset);
    ...
    // Serialize message field [raw_data_enable]
    bufferOffset = _serializer.bool(obj.raw_data_enable, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [vehicle_speed_validity]
    data.vehicle_speed_validity = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [raw_data_enable]
    data.raw_data_enable = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.vehicle_speed_validity !== undefined) {
      resolved.vehicle_speed_validity = msg.vehicle_speed_validity;
    }
    else {
      resolved.vehicle_speed_validity = false
    }
    ...
    if (msg.raw_data_enable !== undefined) {
      resolved.raw_data_enable = msg.raw_data_enable;
    }
    else {
      resolved.raw_data_enable = false
    }
