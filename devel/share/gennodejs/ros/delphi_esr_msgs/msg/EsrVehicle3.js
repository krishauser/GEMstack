...
class EsrVehicle3 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.long_accel_validity = null;
      this.lat_accel_validity = null;
      this.lat_accel = null;
      ...
      this.aalign_avg_ctr_total = null;
      ...
      if (initObj.hasOwnProperty('long_accel_validity')) {
        this.long_accel_validity = initObj.long_accel_validity
      }
      else {
        this.long_accel_validity = false;
      }
      if (initObj.hasOwnProperty('lat_accel_validity')) {
        this.lat_accel_validity = initObj.lat_accel_validity
      }
      else {
      ...
      if (initObj.hasOwnProperty('aalign_avg_ctr_total')) {
        this.aalign_avg_ctr_total = initObj.aalign_avg_ctr_total
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [long_accel_validity]
    bufferOffset = _serializer.bool(obj.long_accel_validity, buffer, bufferOffset);
    // Serialize message field [lat_accel_validity]
    bufferOffset = _serializer.bool(obj.lat_accel_validity, buffer, bufferOffset);
    ...
    // Serialize message field [aalign_avg_ctr_total]
    bufferOffset = _serializer.uint16(obj.aalign_avg_ctr_total, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [long_accel_validity]
    data.long_accel_validity = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [lat_accel_validity]
    data.lat_accel_validity = _deserializer.bool(buffer, bufferOffset);
    ...
    // Deserialize message field [aalign_avg_ctr_total]
    data.aalign_avg_ctr_total = _deserializer.uint16(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.long_accel_validity !== undefined) {
      resolved.long_accel_validity = msg.long_accel_validity;
    }
    else {
      resolved.long_accel_validity = false
    }

    if (msg.lat_accel_validity !== undefined) {
      resolved.lat_accel_validity = msg.lat_accel_validity;
    }
    else {
      resolved.lat_accel_validity = false
    }
    ...
    if (msg.aalign_avg_ctr_total !== undefined) {
      resolved.aalign_avg_ctr_total = msg.aalign_avg_ctr_total;
    }
    else {
      resolved.aalign_avg_ctr_total = 0
    }
