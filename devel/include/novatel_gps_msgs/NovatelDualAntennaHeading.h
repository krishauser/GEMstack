// Generated by gencpp from file novatel_gps_msgs/NovatelDualAntennaHeading.msg
// DO NOT EDIT!


#ifndef NOVATEL_GPS_MSGS_MESSAGE_NOVATELDUALANTENNAHEADING_H
#define NOVATEL_GPS_MSGS_MESSAGE_NOVATELDUALANTENNAHEADING_H
...
struct NovatelDualAntennaHeading_
{
  typedef NovatelDualAntennaHeading_<ContainerAllocator> Type;

  NovatelDualAntennaHeading_()
    : header()
    , novatel_msg_header()
    , solution_status()
    , position_type()
  ...
  NovatelDualAntennaHeading_(const ContainerAllocator& _alloc)
    : header(_alloc)
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> const> ConstPtr;

}; // struct NovatelDualAntennaHeading_

typedef ::novatel_gps_msgs::NovatelDualAntennaHeading_<std::allocator<void> > NovatelDualAntennaHeading;

typedef boost::shared_ptr< ::novatel_gps_msgs::NovatelDualAntennaHeading > NovatelDualAntennaHeadingPtr;
typedef boost::shared_ptr< ::novatel_gps_msgs::NovatelDualAntennaHeading const> NovatelDualAntennaHeadingConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator1> & lhs, const ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
{
  ...
  static const char* value(const ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x9e80eaa83bf25f05ULL;
  static const uint64_t static_value2 = 0x7aea59ce70d859e5ULL;
};

template<class ContainerAllocator>
struct DataType< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::novatel_gps_msgs::NovatelDualAntennaHeading_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // NOVATEL_GPS_MSGS_MESSAGE_NOVATELDUALANTENNAHEADING_H
