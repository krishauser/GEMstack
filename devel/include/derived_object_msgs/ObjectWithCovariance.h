...
bool operator==(const ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator1> & lhs, const ::derived_object_msgs::ObjectWithCovariance_<ContainerAllocator2> & rhs)
{
