...
struct EsrStatus8_
{
  ...
  _canmsg_type canmsg;
   ...
   typedef uint8_t _history_fault_0_type;
  _history_fault_0_type history_fault_0;

   typedef uint8_t _history_fault_1_type;
  _history_fault_1_type history_fault_1;

   typedef uint8_t _history_fault_2_type;
  _history_fault_2_type history_fault_2;

   typedef uint8_t _history_fault_3_type;
  _history_fault_3_type history_fault_3;

   typedef uint8_t _history_fault_4_type;
  _history_fault_4_type history_fault_4;

   typedef uint8_t _history_fault_5_type;
  _history_fault_5_type history_fault_5;

   typedef uint8_t _history_fault_6_type;
  _history_fault_6_type history_fault_6;

   typedef uint8_t _history_fault_7_type;
...
bool operator==(const ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator1> & lhs, const ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.history_fault_0 == rhs.history_fault_0 &&
    lhs.history_fault_1 == rhs.history_fault_1 &&
    lhs.history_fault_2 == rhs.history_fault_2 &&
    lhs.history_fault_3 == rhs.history_fault_3 &&
    lhs.history_fault_4 == rhs.history_fault_4 &&
    lhs.history_fault_5 == rhs.history_fault_5 &&
    lhs.history_fault_6 == rhs.history_fault_6 &&
    lhs.history_fault_7 == rhs.history_fault_7;
}
...
struct MD5Sum< ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xc7431176d5d09e81ULL;
  static const uint64_t static_value2 = 0x8f01fd18ce628e7eULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.history_fault_0);
      stream.next(m.history_fault_1);
      stream.next(m.history_fault_2);
      stream.next(m.history_fault_3);
      stream.next(m.history_fault_4);
      stream.next(m.history_fault_5);
      stream.next(m.history_fault_6);
      stream.next(m.history_fault_7);
    }
...
struct Printer< ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::delphi_esr_msgs::EsrStatus8_<ContainerAllocator>& v)
  {
    ...
    s << indent << "history_fault_0: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_0);
    s << indent << "history_fault_1: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_1);
    s << indent << "history_fault_2: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_2);
    s << indent << "history_fault_3: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_3);
    s << indent << "history_fault_4: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_4);
    s << indent << "history_fault_5: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_5);
    s << indent << "history_fault_6: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_6);
    s << indent << "history_fault_7: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.history_fault_7);
  }
};
